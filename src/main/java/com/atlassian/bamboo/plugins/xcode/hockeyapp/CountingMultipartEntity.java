...
public class CountingMultipartEntity implements RequestEntity {
  private final RequestEntity entity;
  private final ProgressListener listener;

  public CountingMultipartEntity(final RequestEntity entity, final ProgressListener listener) {
    super();
    this.entity = entity;
